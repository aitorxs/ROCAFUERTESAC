...
<html style="height: 100%; overflow: hidden;" xmlns="http://www.w3.org/1999/xhtml">
	...
	<title><?php echo $langs->trans("DolibarrTPV"); ?></title> 
			...
			<div data-role="footer" data-id="pageFooter" data-theme="b" data-position="fixed">
                <div  data-role="navbar" class="nav-glyphish-example" >
                    <ul>
                        ...
                        <?php } else{ ?>
                        <li data-theme="c"><a href="#services" onclick="_TPV.getDraft();" id="user" data-icon="star"><?php echo $langs->trans("History"); ?></a></li>
                        <?php }?>
                    </ul>
                </div>
...
<div data-role="page"  id="services"  data-theme="b" class="type-interior">
	...
	<div data-role="content" >  
		...
		<ul id="listsales" data-theme="c" data-role="listview">
	...
	<div data-role="footer" data-id="pageFooter" data-theme="b" data-position="fixed">
    	<div data-role="navbar" class="nav-glyphish-example" >
			<ul>
				...
				<?php }else {?>
				<li><a href="#services" onclick="_TPV.getDraft();" id="user" data-icon="star"><?php echo $langs->trans("History"); ?></a></li>
				<?php }?>
			</ul>
		</div>
   </div>	
...
<div data-role="page" id="cart" data-theme="b">
    ...
    <div data-role="navbar" class="nav-glyphish-example" >
			<ul>
				...
				<?php }else {?>
				<li><a href="#services" onclick="_TPV.getDraft();" id="" data-icon="grid"><?php echo $langs->trans("History"); ?></a></li>
				<?php }?>
