        ...
        if(!$placewil->is_inUse())
        {
	        if($placewil->is_notInUse())
	        {
	        	if($user->rights->pos->backend)
	        	{
	        		print "<td></td>\n";
	        		print '<td align="left">';
					print '<a class="butAction" href="'.$_SERVER['PHP_SELF'].'?action=closeplace&id='.$cashwil->id.'">'.$langs->trans("CloseIt").'</a>';
					print '</td>';
	        	}
	        	else
	        	{
	        ...
	        elseif ($placewil->is_closed())
	        {
	        	if($user->rights->pos->backend)
	        	{
	        		print "<td></td>\n";
	        		print '<td align="left">';
					print '<a class="butAction" href="'.$_SERVER['PHP_SELF'].'?action=openplace&id='.$cashwil->id.'">'.$langs->trans("OpenIt").'</a>';
					print '</td>';
	        	}
	        	else
	        	{
