...
if ($action == 'create' || $action == 'confirm_paiement' || $action == 'add_paiement')
{
    ...
    if ($result >= 0)
    {
        ...
        print '<input type="hidden" name="thirdpartylabel" id="thirdpartylabel" value="'.dol_escape_htmltag($ticket->thirdparty->name).'">';
        ...
        if ($action != 'add_paiement')
        {
            print '<div style="text-align: center"><br><input type="submit" class="button" value="'.$langs->trans('Save').'"><br></div>';
        }
